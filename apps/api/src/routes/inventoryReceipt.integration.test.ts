...
describe("الصلاحية — §12.2 صفّ «استلام من مورّد» وحده الحاكم", () => {
  ...
  it("**«فيتامين» لا يبلغها إلا المالك** — قراءةٌ للمصفوفة لا حكمٌ عليها", async () => {
    // **وصارت ثلاثًا بالقرار 260 — اشتقاقًا لا حكمًا:** الفئة السابعة
    // «معدات ومستلزمات إنشائية» **لا يمنحها أحدٌ للمشرف ولا للطبيب**،
    // **فتسقط إلى المالك بحكم الاشتقاق** — وهو الاتجاه الآمن (القرار 184:
    // لا يُمنح شيء بالسكوت). **ولا تدخل مخزن العنبر أصلًا.**
    expect([...OWNER_ONLY_RECEIPT_CATEGORIES]).toEqual([
      "فيتامين",
      "معقمات ومطهرات",
