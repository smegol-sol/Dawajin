 ...
 * بمخزنين وصنفين، وحركاتٌ تُكتب مباشرةً في الدفتر.
 *
 * **وكان هنا «لأن لا مسار مخزون يكتبها بعد» — وبطل** (القرار 267): **ثلاثُ
 * خدماتٍ تكتب الدفترَ اليوم**. **فالإدراج المباشر صار له مسارٌ يقابله**،
 * **ويُسجَّل حدًّا معلنًا ولا يُصلَح هنا**: تحويلُه إلى المسار يغيّر ما تقيسه
 * اختباراتُ اللقطة (تقيس اللقطةَ لا مسارَ الحركة)، **وهو صنفُ 245 «إدراجٌ
 * مباشر بجوار مسارٍ قائم» فيُراجَع بأمرٍ مستقلّ لا بالاجتهاد هنا.**
 *
 * لا تُحتسب في التغطية.
 */
