 ...
 * بالسكوت (القرار 184). **وكان هنا «وإسنادُ الخطوات مسارُ المشرف ولم يُبنَ
 * بعد» — وبطل بالقرار 237** (القرار 267): **المسار قائم**
 * (`PATCH /prep-steps/:stepId/assign`)، **فالشرط يُستوفى ولا يبقى معلَّقًا**.
 ...
 * منتجًا ولا كمية اليوم** (القرار 221) — **يسقط هذا الحدّ يوم يُكتب أول كاتبٍ
 * للعمودين**.
 * @limit no-writer housePrepSteps.productId
 * @limit no-writer housePrepSteps.quantityUsed
 *
