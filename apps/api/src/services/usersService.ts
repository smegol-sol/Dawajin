 ...
 *
 * **والتفعيل بابٌ لازم لا زيادة:** `users_tenant_phone_uq` يشمل المعطَّلين
 * عمدًا (#23)، **فبلا تفعيلٍ يصير التعطيل حجزًا أبديًّا لرقم الجوال** — نقرةٌ
 * خاطئة تُخرج إنسانًا من النظام بلا طريق عودة.
 *
