  ...
  return (
    <Tabs screenOptions={useTabBarScreenOptions()}>
      ...
      <Tabs.Screen
        ...
        options={{
          title: "البلاغات",
          tabBarLabel: tabLabel("البلاغات"),
          tabBarIcon: tabIcon(AlertTriangle),
        }}
      />
      <Tabs.Screen
        name="products"
        options={{
          title: "المنتجات",
          tabBarLabel: tabLabel("المنتجات"),
          tabBarIcon: tabIcon(Pill),
        }}
      />
      <Tabs.Screen
        name="reports"
      ...
      <Tabs.Screen
        ...
        options={{
          title: "المزيد",
          tabBarLabel: tabLabel("المزيد"),
          tabBarIcon: tabIcon(MoreHorizontal),
        }}
      />
    </Tabs>
  );
