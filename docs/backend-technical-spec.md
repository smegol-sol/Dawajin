...
### `user_assignments`
id · user_id FK · house_id FK · tenant_id FK · created_at
...
>
> **¹ غير مفروض اليوم — عطب مؤجَّل معلن لا تصميم.** المشرف والطبيب يُسندان **بالمزرعة** لا بالعنبر (تصديق ميداني من المالك)، وجدول `user_assignments` (`user_id · house_id`) لا يدعم ذلك. فنطاقهما مفتوح مؤقتًا على **كل** عنابر المستأجر، ويُصلَح قبل بناء شاشة المشرف (المرحلة 3) — `work-plan.md` §7-ب البند 19. العزل بين المستأجرين غير متأثر إطلاقًا.
>
