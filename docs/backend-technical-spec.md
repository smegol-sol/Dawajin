...
| `inventory_movement_type` | استلام · شحن صادر · شحن وارد · مرتجع صادر · مرتجع وارد · تحويل صادر · تحويل وارد · استهلاك يومي · تنفيذ علاج · استهلاك تجهيز · تسوية جرد · هالك/تلف |
...
| العملية | farmer | supervisor | vet | owner | platform |
|---|---|---|---|---|---|
...
>
> **وصفّ «تسجيل مذبوح»:** المربّي يسجّل **ضمن حصة يعتمدها المالك مسبقًا بلا استئذان**. **والموافقة على تجاوز هذه الحصة لم يسمّها القرار صراحةً** — قُرئت للمالك قياسًا على حصة أمر الصرف؛ **إن كان المقصود المشرف فالصفّ يُصحَّح.**
>
> **و`؟` تعني «غير محسوم» لا «مباح»** (قاعدة #157 البند ٥): **عدّ حمولة التسويق** فاعله هو **السؤال المفتوح الأول** في #160، **والمالك في صفّ «المصادقة والتوزيع»** لم يسمّه القرار (نصّ على المشرف وحده). **ولا يُبنى صفّ موسوم `؟` قبل أن يُحسم.**
>
