...
| `product_category` | علف · دواء · لقاح · فيتامين · **معقمات ومطهرات** · **مستلزمات تشغيل** · **معدات ومستلزمات إنشائية** — **سبعٌ بعد قسمة «مستلزمات»** (القراران 231 و260) |
...
| تأكيد وإنشاء تصحيح | ❌ | ✅ | ❌ | ❌ | ❌ | ❌ |
| تصحيح دون ملاحظة | ❌ | ❌ | ❌ | ❌ | ❌ | ❌ |
| إنشاء شحنة | ❌ | ✅ علف+**مستلزمات تشغيل** | ✅ أدوية+لقاحات | ✅ الكل | ❌ | ❌ |
...
| فتح نزاع | ✅ | ✅ | ✅ | ✅ | ❌ | ❌ |
| حسم نزاع | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ |
| تحويل | ❌ | ✅ بفئته | ✅ بفئته | ✅ | ✅ المركزي (تنفيذًا لا أمرًا) — **مبنيّ بالقرار 259** | ❌ |
...
| ~~استلام من مورّد~~ **[منسوخٌ بالقرار 233]** | ❌ | ~~✅ علف+مستلزمات تشغيل+**معدات ومستلزمات إنشائية** (261)~~ **❌** | ~~✅ أدوية+لقاحات~~ **❌** | ✅ الكل | ✅ **المركزي حصرًا** | ❌ |
| **تأكيد استلام التحويل — مخزن العنبر** | **✅ عنبره** | ❌ | ❌ | **✅** | ❌ | ❌ |
| **تأكيد استلام التحويل — مخزن الموقع** | ❌ | **✅ مخزن موقعه** | ❌ | **✅** | ❌ | ❌ |
| **تأكيد استلام التحويل — المخزن المركزي** | ❌ | ❌ | ❌ | **✅** | **✅ المركزي المُسنَد** | ❌ |
| **إرسال أمر صرف خارجي** | ❌ | ❌ | ❌ | ✅ المركزي | ✅ المركزي | ❌ |
| **المصادقة على أمر صرف خارجي** | ❌ | ❌ | ❌ | ✅ | ✅ | ❌ |
| مصادقة الرصيد الافتتاحي | ❌ | ✅ عنابر مزارعه | ❌ | ✅ المركزي ومخازن المواقع | ❌ | ❌ |
| إنشاء منتج | ❌ | ✅ **مستلزمات تشغيل** | ✅ دواء+لقاح+فيتامين | ❌ | ❌ | ❌ |
| إنشاء مهمة صحية | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
| تنفيذ مهمة صحية | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
| رفع بلاغ صحي | ✅ | ❌ | ❌ | ❌ | ❌ | ❌ |
...
| الرد والتشخيص | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
| إنشاء دفعة | ❌ | **✅ أثرًا للتوزيع لا فعلًا مستقلًّا** | ❌ | **❌ — صُحِّح بالقرار 275** | ❌ | ❌ |
| إدخال شحنة كتاكيت | ❌ | ❌ | ❌ | ✅ | ❌ | ❌ |
...
> **وصفّ «إنشاء دفعة» صُحِّح بالقرار 275 — تبعًا لا حكمًا جديدًا:** كان `✅` للمالك و`✅` للمشرف **حين كانت الدفعة تُنشأ بفعلٍ مستقل**. **و160 «عاشرًا» ٣ جعلها تُنشأ عند التوزيع وحده** — **والمالك `❌` في صفّ التوزيع صراحةً** لأن مصادقته على ما أدخله نقضٌ للمبدأ #155. **فبقاءُ `✅` له في هذا الصفّ يصف بابًا لم يعد قائمًا**: **لا مسار إنشاء دفعةٍ في النظام إطلاقًا** — الدفعةُ أثرُ التوزيع، ولا شيء سواه يُنشئها. **وخانةُ المشرف تبقى `✅` بهذا القيد نفسه لا بإطلاق.**
>
...
>
> **والمعدّات الإنشائية في صفّ المشرف بحكمٍ صريح لا باشتقاق** (القرار 261): **قسمةُ «مستلزمات» أسقطتها إلى المالك بالاشتقاق وحده ولم يقرّره أحد، فصُحِّح**. **وعلّتُه ميدانية:** **المشرف يملك الصيانة والخدمات واستبدال الألواح الشمسية** (#154) — **فمن يطلبها هو من يستلمها**، **وحصرُها في المالك يوقف صيانةً حتى يفرغ لها**. **ويُكتب حكمًا كي لا ينقلب بقسمةٍ قادمة.**
>
> **وحدُّ فئات مخزن العنبر مفروضٌ بالقرار 260 على كل ما يدخله — تحويلًا كان أو استلامًا.** **والمسموح ستٌّ، والممنوع «معدات ومستلزمات إنشائية» وحدها.** **والشرط على مستوى المخزن المستلِم (`عنبر`) لا على ترتيب المحطة** — **فالقرار 235 لا يوجب فرعًا**. **وشمولُ الاستلام أضيقُ من 233 وأوسعُ من نصّ 231**: **إعفاءُ الاستلام في 231 كان مشروطًا بأن يحصر 233 الاستلامَ في المركزيّ، و233 لم يُبنَ فالشرط غائب** — **وحين تُبنى دفعتُه تجد الحدّ قائمًا ولا تنقضه**.
>
> **وصفوف «تأكيد استلام التحويل» الثلاثة أُضيفت بالقرار 258 على حكم 234 — وثلاثةٌ لا صفٌّ واحد لأن المؤكِّد يتبع مستوى المخزن المستلِم** (#161 «ثانيًا»: «صاحب المخزن يُشتق من مستواه»): **مخزن العنبر ← مربّي ذلك العنبر · ومخزن الموقع ← المشرف المُسنَد له · والمركزي ← أمين المخزن المُسنَد — والمالك مع كلٍّ**. **وقائمةٌ موجبة لا شرطٌ سالب**: **دورٌ أو مستوًى جديد لا يملك بالسكوت**.
>
> **و«يبلغه» ليس «يملكه» — وهو ما يوجب حارسًا ثانيًا:** الفرضُ المركزي يفتح مخزن العنبر **لثلاثة أدوار** (مربّيه ومشرف مزرعته وطبيبها، `ua.house_id = … OR ua.farm_id = …`)، **و234 يحصر المؤكِّد في صاحبه** — **فـ`assertWarehouseOwner` تضييقٌ فوق الفرض لا بديلٌ عنه**. **ومخزن العنبر يُملك بإسناد عنبره لا بإسناد مزرعته** (القرار 199).
>
...
| تحويل | تحويل صادر (−) بالمُصدَرة **+ تحويل وارد (+) بالمستلمة فعلًا** — **وقد تفترقان** (القرار 258) |
...
**استقبال الكتاكيت** (#160 «أولًا»، والقراران 274 و275)
```
...
POST /inventory/transfers/:transferId/issue · POST /inventory/transfers/:transferId/confirm
